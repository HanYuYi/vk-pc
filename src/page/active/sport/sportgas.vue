  ...
  <div class="ag_active active_page sportsweek">
            ...
            <div class="section_box_wrapper">
              <div class="active_desc">
               <p>
                ...
                2. 威客体育游戏包括：威客体育、FB体育、BTI体育、平博体育、皇冠体育、沙巴体育、IM体育，用户在领取加油金时选择将其领取至对应的体育游戏钱包，加油金需完成活动规定的3倍体育流水，活动流水未完成前不可再次申请。<br>
                3. 有效流水仅计算产生输赢结果的注单，亚洲盘赔率<0.75、欧洲盘<1.75、美洲盘≤-133、马来盘≤0.75且>0、走盘、注单取消、对冲、未结算、串关、平半盘、实时兑现等不计算为有效流水。<br>
    ...
    <el-dialog
      ...
      <div class="dialog_wrapper sport_rescue_dialog">
        <p class="">加油金：{{initInfo.last_week.bouns}}元</p>
        <div >
...
<style scoped>
.ag_active {
  background: url("~@/assets/active/sports/sportgas/banner.jpg") no-repeat center top;
  position: relative;
}
.no_boder {
  border: none;
