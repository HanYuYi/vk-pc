<template>
  <div class="active_page active-universal-template VideoGameFirstRecharge-page">
      ...
      <div class="wrapper">
        ...
        <div class="active_page_content">
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper">
              <div class="active_time">
                活动期间，新会员首次存款时可申请一次电玩首存优惠，申请成功的用户可享受单笔存款最高{{initData.active_setting.rate}}的存款优惠。
              </div>
            </div>
          ...
          <div class="active_section_box">
            ...
            <div class="gz-content">
              <ol>
                <li>
                  符合条件的会员可在点击本优惠活动页面上“立即首存”按钮后，选择“PT电子钱包”、“PG电子钱包”其中之一进行首存转账。对应的存款本金+活动奖金在转账成功后将自动添加至用户选择的电玩游戏钱包中。
                </li>
                <li>此活动首笔存款定义为：用户注册后的第一笔存款；若用户在申请前将首笔存款从主钱包转出，则不可申请首存优惠。</li>
                <li>申请奖金后需在指定电玩游戏中完成相对应的流水要求，当用户对应电玩钱包余额＜最低投注额且无未结算注单时，系统将自动判定已完成活动规定的有效流水。</li>
                <li>此活动不与其它首存活动共享，每个账户仅限申请一次；不可与老用户召回存款活动同一天参与；领取了此项优惠活动的新用户需先完成活动规定的流水后才可申请平台救援金活动。</li>
                <li>有效流水仅计算产生输赢结果的注单，PT电子游戏中以下游戏不算有效流水：<activeptliushui></activeptliushui>。</li>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.load = true
      this.$http(this.ApiSetting.active.Elec2022.FirstRechargeInit)
        .then(res => {
          console.log('首存初始化', res)
          this.load = false
...
.VideoGameFirstRecharge-page {
  background-image: url('~@/assets/active/elec/FirstRecharge/banner.jpg');
