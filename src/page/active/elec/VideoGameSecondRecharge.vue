<template>
  <div class="active_page active-universal-template VideoGameSecondRecharge-page">
      ...
      <div class="wrapper">
        ...
        <div class="active_page_content">
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper">
              <div class="active_time">
                活动期间，新会员完成注册后的第二笔存款，即可申请一次电玩复存优惠，申请成功的用户可享受单笔存款最高{{initData.active_setting.rate}}的存款优惠。
              </div>
            </div>
          ...
          <div class="active_section_box">
            ...
            <div class="gz-content">
              <ol>
                ...
                <li>此活动复存定义为：用户注册后的第二笔存款；若用户在申请前进行转账操作或未完成电玩首存活动的流水要求，则不可申请复存优惠。</li>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.load = true
      this.$http(this.ApiSetting.active.Elec2022.SecondRechargeInit)
        .then(res => {
          console.log('复存初始化', res)
          this.load = false
...
.VideoGameSecondRecharge-page {
  background-image: url('~@/assets/active/elec/SecondRecharge/banner.jpg');
