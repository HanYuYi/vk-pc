<template>
  <div class="dragonboatfestival2022 active_page">
      ...
      <div class="wrapper">
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper">
              <div class="active_time">
                活动期间，所有VIP会员在平台累计总流水≥{{ initInfo.active_conf.min_bet }}，即可参与端午节专属ROLL房间抽奖。
                <table v-if="load" style="border: 0">
                ...
                <p class="liushui" v-show="!load && initInfo.is_login && initInfo.status !== 2">当前总流水：{{initInfo.bet_amount}}元</p>

                <div class="prize-box">
                  <img src="../../../assets/active/dragonboatfestival2022_prize1.png" alt="">
                  <img src="../../../assets/active/dragonboatfestival2022_prize2.png" alt="">
                </div>
        ...
        <div class="active_section_box">
          ...
          <div class="section_box_wrapper active_rules">
            <ul>
              <li>此活动奖品不可折现，中奖的用户需在ROLL房开奖后的7天之内联系在线客服，并提供个人的详情收货地址，逾期奖品则自动销毁。</li>
...
export default {
  ...
  methods: {
    ...
    getInit () {
      this.load = true
      this.$http(this.ApiSetting.active.getDragonboatfestival2022Init)
        .then(res => {
...
.dragonboatfestival2022 {
  background: url("../../../assets/active/dragonboatfestival2022_banner.png") no-repeat center top;
  .liushui {
    color: #c3c3c3;
    margin-top:20px;
    font-size: 16px;
