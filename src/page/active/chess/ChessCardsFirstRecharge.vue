<template>
  <div class="active_page active-universal-template ChessCardsFirstRecharge-page">
      ...
      <div class="wrapper">
        ...
        <div class="active_page_content">
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper">
              <div class="active_time">
                活动期间，新会员首次存款时可申请一次棋牌首存优惠，申请成功的用户可享受单笔存款最高{{initData.active_setting.rate}}的存款优惠。
              </div>
            </div>
          ...
          <div class="active_section_box">
            ...
            <div class="gz-content">
              <ol>
                <li>符合条件的会员可在点击本优惠活动页面上“立即首存”按钮后，选择“乐游棋牌钱包”、“开元棋牌钱包”、“博乐棋牌钱包”、“凯旋棋牌钱包”其中之一进行首存转账。对应的存款本金+活动奖金在转账成功后将自动添加至用户选择的棋牌游戏钱包中。
                </li>
                <li>此活动首笔存款定义为：用户注册后的第一笔存款；若用户在申请前将首笔存款从主钱包转出，则不可申请首存优惠。</li>
                <li>申请奖金后需在指定棋牌游戏中完成相对应的流水要求，当用户对应棋牌钱包余额＜最低投注额且无未结算注单时，系统将自动判定已完成活动规定的有效流水。</li>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.load = true
      this.$http(this.ApiSetting.active.Chess2022.FirstRechargeInit)
        .then(res => {
...
.ChessCardsFirstRecharge-page {
  background-image: url('~@/assets/active/chess/FirstRecharge/banner.png');
