<template>
  <div class="active_page active-universal-template RealPersonFirstRecharge-page">
      ...
      <div class="wrapper">
        ...
        <div class="active_page_content">
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper">
              <div class="active_time">
                活动期间，新会员首次存款时可申请一次真人首存优惠，申请成功的用户可享受单笔存款最高{{initData.active_setting.rate}}的存款优惠。
              </div>
            </div>
...
export default {
  ...
  methods: {
    ...
    init() {
      ...
      this.load = true
      this.$http(this.ApiSetting.active.RealPerson2022.FirstRechargeInit)
        .then(res => {
          console.log('真人首存初始化', res)
          this.load = false
...
.RealPersonFirstRecharge-page {
  background-image: url('~@/assets/active/realman/RealPersonFirstRecharge/banner.png');
