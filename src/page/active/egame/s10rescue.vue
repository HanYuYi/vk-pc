            ...
            <div class="section_box_wrapper" v-else>
              ...
              <table border="1"  align="center" cellspacing="0" width="100%">
                ...
                <tr class="color_f4d363">
                  <td colspan="2" class="color_07f1b7">次日可领取救援金</td>
                  <td v-for="(item,index) in initInfo.active_setting"
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper">
              <div class="active_desc">
                1. 电竞游戏场馆仅限：小艾电竞、小艾彩池电竞、IM电竞，本活动每日结算时的盈亏将累计计算。<br>
                例：会员A当日首充≥500，投注指定赛事结算后，小艾电竞盈利5000，IM电竞负盈利10000，则该会员当日累积结算为负盈利5000，次日可领取88元的救援彩金。<br>
                ...
                6. 有效投注额仅计算产生输赢结果的注单，电竞赔率＜1.45、注单取消、对冲、未结算等注单不计算为有效投注。<br>
...
.s10rescue{
  background: url("../../../assets/active/s10banner.jpg") no-repeat center top;
  .active_page_content {
