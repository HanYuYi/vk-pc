        ...
        <div class="active_page_content">
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper" v-else>
              ...
              <p class="ffft"
               v-show="isLogin&&(initInfo.status==0||initInfo.status==3||initInfo.status==4)">
          ...
          <div class="active_section_box">
            ...
            <div class="section_box_wrapper">
              <div class="active_desc">
                1. 电竞游戏场馆仅限：小艾电竞、小艾彩池电竞、IM电竞，本活动每日结算时的盈亏将累计计算。例：会员A当日首充≥500，投注指定赛事结算后，威客电竞盈利5000，IM电竞负盈利10000，则该会员当日累积结算为负盈利5000，次日可领取88元的电竞复活金。<br>
                ...
                5. 此活动优惠领取当天不与VIP月救援金活动共享，每位会员每日仅限申请一次。<br>
                6. 有效投注额仅计算产生输赢结果的注单，电竞赔率＜1.5、走盘、注单取消、对冲、未结算、串关、平半盘、实时兑现等不计算为有效流水。<br>
...
export default {
  ...
  methods: {
    ...
    showApplyDialog () {
      ...
      if(this.isLogin&&(this.initInfo.status==1||this.initInfo.status==3||this.initInfo.status==4)) {
        return
      }
...
.s10rescue{
  background: url("../../../assets/active/csgorescue_banner.png") no-repeat center top;
  .active_page_content {
