...
(function(main) {
   ...
   */
  var fecha = {};
  var token = /d{1,4}|M{1,4}|yy(?:yy)?|S{1,3}|Do|ZZ|cnweek|([HhMsDm])\1?|[aA]|"[^"]*"|'[^']*'/g;
  var twoDigits = /\d\d?/;
  var threeDigits = /\d{3}/;
  var fourDigits = /\d{4}/;
  ...
  var formatFlags = {
    ...
    cnweek: function(dateObj, i18n) {
      return i18n.cnweek[dateObj.getDay()];
    },
    M: function(dateObj) {
  ...
  fecha.masks = {
    ...
    chineseDateTimeM: "yyyy年MM月dd日 HH:mm:ss",
